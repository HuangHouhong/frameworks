...
public class Activity extends ContextThemeWrapper
    ...
    /**
     * 一个Activity包含一个Window，
     * Window下包含包含这顶层的DecorView,
     * DecorView 有唯一一个子 View, 他是一个垂直的LinearLayout, 包含这 TitleView 和 ContentView，
     * ContentView通常就是我们自己添加的布局的父布局,
     * 平常我们在Activity#onCreate方法中setContentView就是设置他的子View
     *
